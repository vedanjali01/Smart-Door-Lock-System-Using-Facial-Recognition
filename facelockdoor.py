...
d=0
while q<=2:
    data_path = 'C:/Users/Girish Sai N/Desktop/Training_pictures/'
    ...
    q+=1
face_classifier = cv2.CascadeClassifier('C:/Users/Girish Sai N/Desktop/FACELOCKING-DOOR-USING-PYTHON-AND-ARDUINO-PROGRAMING-master/requirements/haarcascade_frontalface_default.xml')
...
if x>=5:
    ...
    var = 'a'
    c=var.encode()
    speak("Face recognition complete..it is matching with database...welcome..mam....Door is openning for 5 seconds")
    ard.write(c)
    time.sleep(4)
elif c==30:
